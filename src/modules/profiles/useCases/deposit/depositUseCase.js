const {updateBalance} = require("../../../profiles/profileRepository");
...
const depositUseCase = async(userId, amount) => {
    ...
    if(amount > totalJobsToPay/4)
        throw new AppError('Unable to deposit - amout greater than limit allowed', 400)
